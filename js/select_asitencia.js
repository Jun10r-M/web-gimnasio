...
function refrescar() {
    $.ajax({
        ...
        success: function(data) {
            ...
            data.forEach(row => {
                tbody.append(
                    `<tr elementoid="${row.idAsistencia}">
                        <td style="text-align:center">${row.idAsistencia}</td>
                        <td style="text-align:center">${row.idCLiente}</td>
                        <td style="text-align:center">${row.idUsuario}</td>
                        <td style="text-align:center">${row.fechaEntrada}</td>
                        <td style="text-align:center">${row.fechaSalida}</td>
